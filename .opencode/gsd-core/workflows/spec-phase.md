...
```bash
INIT=$(node "/Users/rony/dev/abcgame/.opencode/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/rony/dev/abcgame/.opencode/gsd-core/templates/spec.md.
