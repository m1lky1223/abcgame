...
```
Agent(
  prompt="Read /Users/rony/dev/abcgame/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/rony/dev/abcgame/.opencode/gsd-core/templates/SECURITY.md`
