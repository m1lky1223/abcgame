...
```bash
INIT=$(node "/Users/rony/dev/abcgame/.opencode/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/rony/dev/abcgame/.opencode/gsd-core/bin/gsd-tools.cjs" commit \
