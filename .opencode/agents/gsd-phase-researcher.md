...
@/Users/rony/dev/abcgame/.opencode/gsd-core/references/thinking-models-research.md
...
```bash
node "/Users/rony/dev/abcgame/.opencode/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
