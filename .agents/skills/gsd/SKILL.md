...
When this skill is loaded, the agent is trained to interpret and run any GSD command defined in the [.opencode/command/](file:///Users/rony/dev/abcgame/.opencode/command) directory.
...
1. **Load Command Specification**:
   * Navigate to the [.opencode/command/](file:///Users/rony/dev/abcgame/.opencode/command) folder.
   * View the markdown file corresponding to the command (e.g., [gsd-new-project.md](file:///Users/rony/dev/abcgame/.opencode/command/gsd-new-project.md) or [gsd-plan-phase.md](file:///Users/rony/dev/abcgame/.opencode/command/gsd-plan-phase.md)).
