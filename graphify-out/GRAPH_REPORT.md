# Graph Report - abcgame  (2026-06-07)

## Corpus Check
- 473 files · ~482,998 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4595 nodes · 5391 edges · 495 communities (418 shown, 77 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9e2285a1`
...
1. `files` - 436 edges
2. `Renderer` - 273 edges
3. `Canvas2DRenderer` - 51 edges
4. `CarnivalMode` - 41 edges
5. `ThemedLetterQuestMode` - 41 edges
6. `agents` - 34 edges
7. `ALL_LETTERS` - 34 edges
8. `workflow` - 33 edges
9. `AlphabetArcadeMode` - 31 edges
10. `LetterRunnerMode` - 31 edges

## Surprising Connections (you probably didn't know these)
- `keyInput()` --calls--> `buildGameInput()`  [EXTRACTED]
  src/__tests__/LetterPopCore.test.ts → src/game/GameModeStrategy.ts
- `AIPromptCreatorProps` --references--> `DynamicGameConfig`  [EXTRACTED]
  src/components/AIPromptCreator.tsx → src/game/adapters/LocalGenerator.ts
- `GameCanvasProps` --references--> `Engine`  [EXTRACTED]
  src/components/GameCanvas.tsx → src/game/Engine.ts
- `HUDProps` --references--> `GameState`  [EXTRACTED]
  src/components/HUD.tsx → src/game/Engine.ts
- `MainMenuProps` --references--> `GameMode`  [EXTRACTED]
  src/components/MainMenu.tsx → src/game/Engine.ts

## Import Cycles
- None detected.

## Communities (495 total, 77 thin omitted)
...
Cohesion: 0.05
Nodes (7): AquariumMode, BakeryMode, ConstructionSiteMode, MailCarriersMode, PizzaDeliveryMode, ZombieDefenseMode, Renderer

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (16): Background, Canvas2DRenderer, drawCompoundEyes(), drawEyes(), drawFeature(), drawLetterBody(), drawPairEyes(), drawSingleEye() (+8 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (42): ALL_LETTERS, ALLY_LETTERS, CharacterDef, ENEMY_LETTERS, CREATURE_WORDS, CREATURES, TREAT_WORDS, ZOMBIE_NAMES (+34 more)
...
Cohesion: 0.09
Nodes (9): generateGeminiConfig(), mergeWithLocalHints(), DynamicGameConfig, generateLocalConfig(), AIPromptCreatorProps, SUGGESTIONS, DynamicLetter, DynamicPromptStrategy (+1 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (18): SelfContainedAdapter, SelfContainedMode, createStrategy(), InputBoundsProvider, GameInput, GameModeStrategy, Gesture, InputRect (+10 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (20): CHARACTERS, CRITICS, Recipe, RECIPES, DanceState, DanceZombie, JUDGES, WORDS_POOL (+12 more)
...
Cohesion: 0.07
Nodes (19): drawCharacter(), Fighter, FighterAction, HitSpark, Balloon, BoothDef, BOOTHS, CarnivalState (+11 more)
...
Cohesion: 0.10
Nodes (10): AngryLetter, AngryMode, AngryState, BlockCell, HP_COLORS, LevelDef, LEVELS, ODD_COLORS (+2 more)

### Community 23 - "Community 23"
Cohesion: 0.07
Nodes (29): dependencies, react, react-dom, devDependencies, happy-dom, playwright, @types/react, @types/react-dom (+21 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (29): workflow, ai_integration_phase, auto_advance, auto_prune_state, code_review, code_review_command, code_review_depth, discuss_mode (+21 more)
...
Cohesion: 0.08
Nodes (24): Agent Context Profiles, Agent personas, AGENTS.md — ABC World, All 31 game modes, Architecture (current + planned), Beads Issue Tracker, Beads Issue Tracker, Commands (+16 more)

### Community 32 - "Community 32"
Cohesion: 0.13
Nodes (6): ACTS, CircusItem, CircusMode, Confetti, WordDef, WORDS_POOL
...
Cohesion: 0.14
Nodes (7): Bullet, OddbodShooter, SHOOTERS, ShootingGalleryMode, Zombie, ZOMBIE_TYPES, ZombieType
...
Cohesion: 0.11
Nodes (18): Agent's Discretion, Architectural Responsibility Map, Architecture Patterns, Code Examples, Common Pitfalls, Drawing Responsibility, Environment Availability, Interface Injection Pattern (+10 more)
...
Cohesion: 0.11
Nodes (18): 1. System Topology & Lifecycle, 2. Core Loop Orchestration, 3. Input Handling & Normalization, 4. The Strategy & Adapter Patterns, 5. Character Representation & Rendering, 6. Planned Refactoring: Split Renderer, A. Core Shared Loop (backed by [LetterPopCore.ts](file:///Users/rony/dev/abcgame/src/game/strategies/LetterPopCore.ts)), ABC World Repository Architecture (+10 more)

### Community 50 - "Community 50"
Cohesion: 0.11
Nodes (18): agent_skills, brave_search, claude_md_path, commit_docs, exa_search, firecrawl, granularity, graphify (+10 more)
...
Cohesion: 0.18
Nodes (8): GameCanvasProps, HUDProps, MainMenuProps, MODE_ROWS, ModeEntry, GameMode, GameState, Screen
...
Cohesion: 0.13
Nodes (14): Canonical References, Deferred Ideas, Drawing Responsibility, Established Patterns, Existing Code Insights, Implementation Decisions, Integration Points, Interface Injection Pattern (+6 more)
...
Cohesion: 0.14
Nodes (13): Anti-Patterns, Architectural Constraints, Architecture, Component Responsibilities, Data Flow, Direct Canvas Drawing in Game Entities, Direct DOM Event Handling in Gameplay Logic, Entry Points (+5 more)
...
Cohesion: 0.17
Nodes (11): ABC World — React Native Mobile Port, Active, Constraints, Context, Core Value, Evolution, Key Decisions, Out of Scope (+3 more)
...
Cohesion: 0.18
Nodes (10): Accomplishments, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance, Plan 01-01: Define Renderer Interface & Canvas2DRenderer Summary (+2 more)

### Community 106 - "Community 106"
Cohesion: 0.18
Nodes (10): Accomplishments, Decisions Made, Deviations from Plan, Files Created/Modified, Issues Encountered, Next Phase Readiness, Performance, Plan 01-02: Migrate Entity Classes & Delegate to Renderer Summary (+2 more)
...
Cohesion: 0.24
Nodes (4): DetectiveMode, SceneObject, SCENES, WITNESS_LINES

### Community 111 - "Community 111"
Cohesion: 0.25
Nodes (3): MemCard, MemoryMatchMode, REACTIONS

### Community 113 - "Community 113"
Cohesion: 0.18
Nodes (10): dependencies, @modelcontextprotocol/sdk, zod, description, main, name, scripts, start (+2 more)

### Community 114 - "Community 114"
Cohesion: 0.18
Nodes (10): 1. Current State of the Repository, 2. Completed Milestones, 3. Engineering Roadmap, ABC World Memory & Roadmap, Core Architecture Documentation, Custom Repository Helper MCP Server, Developer Environment Setup, Stage 1: Renderer Interface Decoupling (High Priority) (+2 more)
...
Cohesion: 0.20
Nodes (9): Overview, Phase 1: Renderer Interface Decoupling, Phase 2: React Native Shell & Code Sharing, Phase 3: React Native Skia Renderer & Input, Phase 4: Android Build & APK packaging, Phase Details, Phases, Progress (+1 more)
...
Cohesion: 0.22
Nodes (8): 1. Quick Navigation, 2. Coding Conventions & Idioms, 3. Custom Repository Tools, 4. Architectural Target: The Renderer Interface Split, A. Input Handling, AI Developer Notes, B. Adding a New Game Mode, C. Character Definition
...
Cohesion: 0.22
Nodes (8): app, CHARACTERS, MODE_INSTRUCTIONS, MODES, PORT, server, transport, WORDS

### Community 154 - "Community 154"
Cohesion: 0.22
Nodes (8): Android Packaging & APK (APK), Mobile Shell & Code Sharing (PORT), Out of Scope, Renderer Decoupling (REND), Requirements: Mobile APK & React Native Port, Skia Rendering & Touch Input (SKIA), Traceability, v1 Requirements
...
Cohesion: 0.25
Nodes (7): CHASER_TYPES, ODDBODS, RunnerChaser, RunnerCollectible, RunnerObstacle, RunnerOddbod, RunnerState
...
Cohesion: 0.25
Nodes (5): __dirname, __filename, REPO_ROOT, server, transport

### Community 176 - "Community 176"
Cohesion: 0.25
Nodes (7): 1. `get_repo_summary`, 2. `audit_game_modes`, 3. `canvas_migration_progress`, 4. `run_repo_validation`, ABC World Repository Helper MCP Server, Available Tools, Configuration & Usage

### Community 177 - "Community 177"
Cohesion: 0.25
Nodes (7): dependencies, @modelcontextprotocol/sdk, description, main, name, type, version
...
Cohesion: 0.25
Nodes (7): /Users/rony/dev/abcgame/.opencode/gsd-core/*, permission, external_directory, read, plugin, /Users/rony/dev/abcgame/.opencode/gsd-core/*, $schema
...
Cohesion: 0.29
Nodes (6): Deferred Ideas, Drawing Responsibility, Interface Injection Pattern, Phase 1: Renderer Interface Decoupling - Discussion Log, Renderer API Granularity, the agent's Discretion
...
Cohesion: 0.29
Nodes (6): Codebase Concerns, Fragile Areas, Known Bugs, Performance Bottlenecks, Security Considerations, Tech Debt

### Community 196 - "Community 196"
Cohesion: 0.29
Nodes (6): Code Style, Coding Conventions, Error Handling, Import Organization, Logging, Naming Patterns
...
Cohesion: 0.29
Nodes (6): Coverage, Mocking, Test File Organization, Test Framework, Test Structure, Testing Patterns

### Community 199 - "Community 199"
Cohesion: 0.29
Nodes (6): AI_COLORS, AI_NAMES, KART_ODDBODS, KartObstacle, KartOddbod, KartPrompt

### Community 200 - "Community 200"
Cohesion: 0.29
Nodes (6): Defender, DEFENDER_STATS, InkDrop, Projectile, ZOMBIE_LETTERS, ZombieUnit

### Community 201 - "Community 201"
Cohesion: 0.29
Nodes (6): ABC World MCP Server, Connect Claude to a remote MCP URL, Deploy to the cloud, Run (HTTP server for remote access), Setup, Tools
...
Cohesion: 0.33
Nodes (5): ABC World, Commands, Game Modes, Quick Start, Tech Stack
...
Cohesion: 0.50
Nodes (3): Artifacts this phase produces, Objective, Plan 01-01: Define Renderer Interface & Canvas2DRenderer

### Community 296 - "Community 296"
Cohesion: 0.50
Nodes (3): Artifacts this phase produces, Objective, Plan 01-02: Migrate Entity Classes & Delegate to Renderer

### Community 297 - "Community 297"
Cohesion: 0.50
Nodes (3): Artifacts this phase produces, Objective, Plan 01-03: Decouple Engine & Verify Codebase Parities
...
## Knowledge Gaps
- **2932 isolated node(s):** `last_dolt_commit`, `timestamp`, `database`, `backend`, `dolt_mode` (+2927 more)
...
- **Why does `Renderer` connect `Community 1` to `Community 2`, `Community 3`, `Community 130`, `Community 131`, `Community 132`, `Community 133`, `Community 8`, `Community 9`, `Community 10`, `Community 7`, `Community 18`, `Community 21`, `Community 22`, `Community 150`, `Community 151`, `Community 28`, `Community 31`, `Community 32`, `Community 35`, `Community 36`, `Community 292`, `Community 39`, `Community 40`, `Community 171`, `Community 172`, `Community 46`, `Community 56`, `Community 57`, `Community 60`, `Community 63`, `Community 199`, `Community 200`, `Community 74`, `Community 80`, `Community 109`, `Community 110`, `Community 111`, `Community 112`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `files` connect `Community 0` to `Community 307`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `ShootingGalleryMode` connect `Community 40` to `Community 8`?**
